...
export default function SliderContainer({ children, prop }) {
  ...
  return (
    <div className="bg-[#FFF4EA] border-black border-[1px] my-12 flex flex-col justify-center items-center  rounded-[20px] w-full h-[372px]">
      {current}
      <Carousel
        itemsPerView={2}
        opts={{
          ...
          {children.map((item) => {
            return (
              <CarouselItem
                ...
                } basis-[712px] flex justify-center items-center transition-all duration-700 `}
              >
                <div
                  className={` transition-all duration-700  flex rounded-[9px] border-[#666666] border-[1px] border-b-[4px] w-[712px] ${
                    item.id == current ? "h-[186px] " : "h-[132px]"
                  } `}
                >
                  <div className="w-full h-full flex flex-col">
                    ...
                    <div className="slide-footer px-2 h-[3rem] border-t-[1px] border-black/10 flex justify-between items-center [&>*]:flex [&>*]:justify-center [&>*]:items-center text-[8px]">
                      <div className="flex gap-0.5">
                        ...
                        <p className={`${item.id==current?'text-[14px]':''}`}>28نظر</p>
                      </div>
                      <div className="">
                      ...
                      <div className={`${item.id==current?'text-[14px]':''}`}>زمان مطالعه : {item.readingTime} دقیقه</div>
                    </div>
                  </div>
                  <div className="img-container rounded-r-[6px] w-[256px] h-full bg-amber-500"></div>
                </div>
              </CarouselItem>
            );
          })}
      ...
      <div className="w-full h-20 flex justify-center items-center gap-2">
        <button
          ...
          className="w-[36px] bg-white transition-all flex justify-center items-center hover:border-b-[1px] duration-200 rounded-[5px] border-[1px] border-black border-b-[3px] h-[36px]"
        >
          <svg
            width="10"
            height="17"
        ...
        <button
          ...
          className="w-[36px] bg-white transition-all hover:border-b-[1px] duration-200  flex justify-center items-center rounded-[5px] border-[1px] border-black border-b-[3px] h-[36px]"
        >
          <svg
            width="10"
            height="17"
