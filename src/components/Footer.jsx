...
export default function Footer() {
  return (
    <>
      <div className="w-full font-kahroba mt-4 md:h-[281px] h-max flex flex-col items-center bg-[#FDF7E9] border-t-[1px] border-[#FF8A00]">
        <div className="lg:w-[1280px] font-kahroba  flex flex-col lg:flex-row justify-evenly  bg-[#FDF7E9] px-3 gap-8 py-8 w-full m">
          <div className="md:w-[318px] font-kahroba  bg-white w-full h-[202px] border-[1px] border-black rounded-[20px]">
            <h1 className="w-full text-center font-kahroba font-[100] h-10 flex justify-center items-center">
              دسترسی سریع
            </h1>
          </div>
          <div className="md:w-[318px] font-kahroba font-[300] bg-white  w-full h-[202px] border-[1px] border-black rounded-[20px] flex flex-col">
            <div className="h-full w-full px-8 py-5 gap-4 flex flex-col">
              <div className="w-full flex items-center justify-center md:font-semibold text-end px-2 text-[12px] md:text-[14px] rounded-full h-10 bg-gray-100 outline-dotted font-vazir font-[400] outline-gray-500">
                تهران - خیابان جمهوری - پلاک ۱۲۵۹
              </div>
              <div className="w-full rounded-full h-10 flex items-center justify-center bg-gray-100 outline-dotted outline-gray-500">
                <p className="text-[12px] font-vazir font-[400] flex items-center">
                  (021) -
                </p>
                <p className="font-vazir font-[400]">۶۲۹۹۹۶۵۷</p>{" "}
              </div>
            </div>
            ...
            <div className="w-full flex border border-black md:grid-cols-[1fr,200px] md:grid flex-col h-full hover:m-0 -mt-1 bg-white rounded-[20px] duration-200 transition-all ">
              <div className="md:w-auto py-2 ">
                <div className="w-full flex flex-col justify-center items-center">
                  ...
                  <p className=" text-center font-kahroba font-[100]">
